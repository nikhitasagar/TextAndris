...
public class ContactsEditText extends MultiAutoCompleteTextView {
    ...
    private class ContactsAdapter extends CursorAdapter {
        ...
        public Object getItem(int position) {
            ...
            contact.phone = cursor.getString(ContactsQuery.P_NUMBER_COLUMN);
        ...
        public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
            ...
            holder.phone = (TextView) dropdownView.findViewById(android.R.id.text2);
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            final String phoneNo = cursor.getString(ContactsQuery.P_NUMBER_COLUMN);
        ...
        private Bitmap loadContactPhotoThumbnail(String photoData, int imageSize) {
            ...
            try {
                ...
                if (Utils.hasHoneycomb() && photoData != null) {
                    ...
                    final Uri contactUri = Uri.withAppendedPath(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, photoData);
    ...
    private static interface ContactsQuery {
        ...
        final static String SELECTION =
                ...
                "<>''" + " AND " + ContactsContract.CommonDataKinds.Phone.IN_VISIBLE_GROUP + "=1 AND " +
        ...
        final static String SORT_ORDER = ContactsContract.CommonDataKinds.Phone.TIMES_CONTACTED + " DESC";
        ...
        final static String[] PROJECTION = {
            ...
            // available in earlier versions of Android, so you must use ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME
            // instead.
            Utils.hasHoneycomb() ? ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME_PRIMARY : ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME,
            ...
            // android.provider.ContactsContract.ContactsContract.CommonDataKinds.Phone.
            Utils.hasHoneycomb() ? ContactsContract.CommonDataKinds.Phone.PHOTO_THUMBNAIL_URI : ContactsContract.CommonDataKinds.Phone._ID,
        ...
        final static int P_NUMBER_COLUMN = 4;
    }
